...
func (s Service) GetStruktur(ctx context.Context, periode, pt, dept string, nip string) ([]entity.Grpteri, error) {

	resulst, err := s.data.GetStrukturAll(ctx, periode, pt, dept, nip)
	if err != nil {
